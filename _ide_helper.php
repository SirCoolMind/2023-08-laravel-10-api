...
namespace Honeybadger\HoneybadgerLaravel\Facades {
     ...
     */        class Honeybadger {
         ...
         * @throws \Honeybadger\Exceptions\ServiceException
         * @static 
         */        public static function checkin($idOrSlug)
        {            //Method inherited from \Honeybadger\Honeybadger         
                        /** @var \Honeybadger\HoneybadgerLaravel\HoneybadgerLaravel $instance */
                        $instance->checkin($idOrSlug);
        }
                    /**
         ...
         * @return void 
         * @static 
         */        public static function event($eventTypeOrPayload, $payload = null)
        {            //Method inherited from \Honeybadger\Honeybadger         
                        /** @var \Honeybadger\HoneybadgerLaravel\HoneybadgerLaravel $instance */
                        $instance->event($eventTypeOrPayload, $payload);
        }
                    /**
         ...
         *
         * @static 
         */        public static function beforeNotify($callback)
        {            //Method inherited from \Honeybadger\Honeybadger         
                        /** @var \Honeybadger\HoneybadgerLaravel\HoneybadgerLaravel $instance */
                        return $instance->beforeNotify($callback);
        }
                    /**
         * {@inheritDoc}
         *
         * @static 
         */        public static function beforeEvent($callback)
        {            //Method inherited from \Honeybadger\Honeybadger         
                        /** @var \Honeybadger\HoneybadgerLaravel\HoneybadgerLaravel $instance */
                        return $instance->beforeEvent($callback);
        }
                    /**
         * 
         *
         * @return \Honeybadger\Repository 
         * @static 
...
namespace Illuminate\Console\Scheduling {
     ...
     */        class Event {
         ...
         * @static 
         */        public static function thenPingHoneybadger($checkinIdOrName, $environments = null)
        {
                        return \Illuminate\Console\Scheduling\Event::thenPingHoneybadger($checkinIdOrName, $environments);
        }
                    /**
         * 
         *
         ...
         * @see \Honeybadger\HoneybadgerLaravel\HoneybadgerServiceProvider::registerEventHooks()
         * @static 
         */        public static function pingHoneybadgerOnSuccess($checkinIdOrName, $environments = null)
        {
                        return \Illuminate\Console\Scheduling\Event::pingHoneybadgerOnSuccess($checkinIdOrName, $environments);
        }
            }
    }
